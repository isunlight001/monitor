...
//        for (int i = 0; i < navList.size(); i++) {
    ...
    public String generateFundAIAnalysis(List<FundNav> fundNavList, String fundCode, String fundName) {
        ...
        prompt.append("角色：你是一名经验丰富的基金波段投资分析专家，擅长技术面分析，提示中的基金都有一定仓位，连续下跌时会提示买入5%-20%的仓位，连续上涨会提示抛出5%-20%的仓位。\n");
...
//        prompt.append("风险评估：当前基金的主要风险点是什么？\n");
        prompt.append("投资建议：给出确定买入或者抛出的基金比例(百分比)及理由，输出内容要简洁明了不超过50个字。\n");
