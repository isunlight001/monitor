...
public interface MonitorFundMapper {
     ...
     * @return 影响行数
     */
    @Insert("INSERT INTO fund_monitor (fund_code, fund_name, remark, enabled, create_time, update_time) " +
            "VALUES (#{fundCode}, #{fundName}, #{remark}, #{enabled}, NOW(), NOW())")
     ...
     * @return 影响行数
     */
    @Update("UPDATE fund_monitor SET fund_name = #{fundName}, remark = #{remark}, enabled = #{enabled}, update_time = NOW() " +
            "WHERE id = #{id}")
